<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-sitemap"></i> {{ trans('app.labels.update') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('update.edit.faqs', ['faq' => $entity->id]) }}"
                          method="post"
                          class="form-horizontal form-label-left" id="faqs_update_fm" novalidate>
