<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-cubes"></i> {{ trans('app.labels.update') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('update.edit.subjects', ['subject' => $entity->id]) }}"
                          method="post"
                          class="form-horizontal form-label-left" id="subjects_update_fm" novalidate>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="assigned_user_id">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select class="form-control select2" id="responsible_id" name="responsible_id" required>
                                    ...
                                    @foreach($users as $user)
                                        <option value="{{ $user->id }}" @if($user->id == $entity->responsible_id) selected @endif>
                                            {{ $user->fullName() }}
                                        </option>
                                    @endforeach
                                </select>
