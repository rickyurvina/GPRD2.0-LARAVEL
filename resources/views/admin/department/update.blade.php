...
<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-sitemap"></i> {{ trans('departments.labels.update') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('update.edit.departments', ['id' => $entity->id]) }}"
                          method="post"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="description" id="description"
                                          ...
                                          placeholder="{{ trans('departments.placeholders.description') }}">{{ $entity->description }}</textarea>
                            </div>
                        </div>
                                    ...
                                    <select class="form-control select2" id="parent_id" name="parent_id">
                                        ...
                                        @foreach($departments as $department)
                                            <option value="{{ $department->id }}"
                                                    @if(isset($entity->parent_id) && $department->id == $entity->parent_id) selected @endif>
                                                {{ $department->name }}
                                            </option>
                                        @endforeach
                                    </select>
