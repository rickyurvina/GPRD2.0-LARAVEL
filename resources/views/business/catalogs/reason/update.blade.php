@permission('edit.reasons.module_configuration_catalogs')
...
<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-tasks"></i> {{ trans('reasons.labels.update') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('update.edit.reasons.module_configuration_catalogs', ['id' => $entity->id]) }}" method="post"
                          class="form-horizontal form-label-left" id="reasons_edit_fm">
