...
<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-shopping-cart"></i> {{ trans('cpc.labels.new') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('store.create.cpc.module_configuration_catalogs') }}" method="post"
                          class="form-horizontal form-label-left" id="cpc_create_fm" novalidate>
