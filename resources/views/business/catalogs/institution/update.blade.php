@permission('edit.institution.module_configuration_catalogs')
...
<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-university"></i> {{ trans('institution.labels.update') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('update.edit.institution.module_configuration_catalogs', ['id' => $entity->id]) }}" method="post"
                          class="form-horizontal form-label-left" id="institution_edit_fm">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" name="code" id="code" data-inputmask="'mask': '999-9999'" class="form-control col-md-7 col-sm-7 col-xs-12"
                                       @if(count($entity->budgetItems) || count($entity->incomes)) disabled @endif
                                       value="{{ $entity->code }}"/>
                            </div>
