@permission('edit.measure_units.module_configuration_catalogs')
...
<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-balance-scale"></i> {{ trans('measure_units.labels.update') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('update.edit.measure_units.module_configuration_catalogs', ['id' => $entity->id]) }}" method="post"
                          class="form-horizontal form-label-left" id="measure_units_edit_fm">
...
<script>
    $(() => {
        ...
        let $form = $('#measure_units_edit_fm');
