...
<div class="modal-content" id="intersection_create">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('intersection.labels.create') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form" action="{{ route('store.create.intersection.inventory_roads') }}"
                  method="post"
                  class="form-horizontal form-label-left" id="intersection_create_fm">
                @csrf
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="lat" id="lat"
                               ...
                               placeholder="{{ trans('intersection.placeholders.lat') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="dist" id="dist"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('intersection.placeholders.dist') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <textarea name="observ" id="observ" class="form-control col-md-7 col-sm-7 col-xs-12" rows="5"
                                  placeholder="{{ trans('intersection.placeholders.observ') }}"></textarea>
                    </div>
                </div>
...
<script>
    $(() => {
        ...
        let $form = $('#intersection_create_fm');
