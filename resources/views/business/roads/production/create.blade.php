...
<div class="modal-content" id="production_create">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">
            <span aria-hidden="true">×</span>
        </button>
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('production.labels.create') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form" action="{{ route('store.create.production.inventory_roads') }}"
                  method="post"
                  class="form-horizontal form-label-left" id="production_create_fm">
                @csrf
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="prod1" id="prod1"
                               ...
                               placeholder="{{ trans('production.placeholders.prod1') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="prod2" id="prod2"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.prod2') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="prod3" id="prod3"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.prod3') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="vol1" id="vol1"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.vol1') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="vol2" id="vol2"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.vol2') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="vol3" id="vol3"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.vol3') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="dest1" id="dest1"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.dest1') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="dest2" id="dest2"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.dest2') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="dest3" id="dest3"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.dest3') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="val1" id="val1"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.val1') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="val2" id="val2"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.val2') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="val3" id="val3"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('production.placeholders.val3') }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <textarea name="observ" id="observ" class="form-control col-md-7 col-sm-7 col-xs-12" rows="5"
                                  placeholder="{{ trans('production.placeholders.observ') }}"></textarea>
                    </div>
                </div>
