...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('characteristics_of_track.labels.new_terrain_type') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.terrain_type.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="terrain_type_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#terrain_type_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\TerrainType',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('characteristics_of_track.messages.validations.terrain_type_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#terrain_type_tb').DataTable();
