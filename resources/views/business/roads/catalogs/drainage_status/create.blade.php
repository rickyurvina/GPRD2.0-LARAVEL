@permission('create.drainage_status.inventory_roads_catalogs')
...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('hdm4.labels.new_drainage_status') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.drainage_status.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="drainage_status_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#drainage_status_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\DrainageStatus',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('hdm4.messages.validations.drainage_status_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#drainage_status_tb').DataTable();
