@permission('create.drainage_type.inventory_roads_catalogs')
...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('hdm4.labels.new_drainage_type') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.drainage_type.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="drainage_type_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#drainage_type_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\DrainageType',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('hdm4.messages.validations.drainage_type_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#drainage_type_tb').DataTable();
