...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('mines.labels.new_mines_material') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.mines_material.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="mines_material_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#mines_material_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\MinesMaterial',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('mines.messages.validations.mines_material_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#mines_material_tb').DataTable();
