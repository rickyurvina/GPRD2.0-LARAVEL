...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('bridge.labels.new_bridge_rolling_layer') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.bridge_rolling_layer.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="bridge_rolling_layer_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#bridge_rolling_layer_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\BridgeRollingLayer',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('bridge.messages.validations.bridge_rolling_layer_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#bridge_rolling_layer_tb').DataTable();
