@permission('create.rolling_surface.inventory_roads_catalogs')
...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('hdm4.labels.new_rolling_surface') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.rolling_surface.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="rolling_surface_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#rolling_surface_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\RollingSurface',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('hdm4.messages.validations.rolling_surface_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#rolling_surface_tb').DataTable();
