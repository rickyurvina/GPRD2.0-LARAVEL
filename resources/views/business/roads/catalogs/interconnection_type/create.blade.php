...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('general_characteristics_of_track.labels.new_interconnection_type') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.interconnection_type.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="interconnection_type_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#interconnection_type_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\InterconnectionType',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('general_characteristics_of_track.messages.validations.interconnection_type_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#interconnection_type_tb').DataTable();
