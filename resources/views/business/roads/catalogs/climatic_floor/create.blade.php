@permission('create.climatic_floor.inventory_roads_catalogs')
...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('hdm4.labels.new_climatic_floor') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.climatic_floor.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="climatic_floor_create_fm" novalidate>
...
<script>
    $(() => {
        ...
        let $form = $('#climatic_floor_create_fm');
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\ClimaticFloor',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('hdm4.messages.validations.climatic_floor_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#climatic_floor_tb').DataTable();
