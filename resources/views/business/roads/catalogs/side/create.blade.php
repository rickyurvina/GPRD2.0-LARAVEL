@permission('create.side.inventory_roads_catalogs')
...
<div id="myModal" class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><i class="fa fa-road"></i> {{ trans('ditch.labels.new_side') }}
        </h4>
    </div>

    <div class="mt-5">
        <form role="form" action="{{ route('store.create.side.inventory_roads_catalogs') }}" method="post"
              class="form-horizontal form-label-left" id="side_create_fm" novalidate>
...
<script>
    $(() => {
            ...
            descrip: {
                ...
                remote: {
                    ...
                    data: {
                        ...
                        model: 'App\\Models\\Business\\Roads\\Catalogs\\Side',
                    }
                }
            }
        };
        ...
        $validateDefaults.messages = {
            descrip: {
                remote: '{{ trans('ditch.messages.validations.side_uniqueDesc') }}'
            }
        };

        $form.validate($.extend(false, $validateDefaults));

        let datatable = $('#side_tb').DataTable();
