                        ...
                        <select class="form-control select2"
                            ...
                            @foreach($states as $state)
                                <option value="{{ $state->descripcion }}"
                                        @if($entity->esuperf == $state->descripcion) selected @endif>
                                    {{ $state->descripcion }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            @foreach($states as $state)
                                <option value="{{ $state->descripcion }}"
                                        @if($entity->esenhori == $state->descripcion) selected @endif>
                                    {{ $state->descripcion }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                            ...
                            @foreach($states as $state)
                                <option value="{{ $state->descripcion }}"
                                        @if($entity->esenvert == $state->descripcion) selected @endif>
                                    {{ $state->descripcion }}
                                </option>
                            @endforeach
                        </select>
