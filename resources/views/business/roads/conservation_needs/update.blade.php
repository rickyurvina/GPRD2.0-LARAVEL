@permission('edit.conservation_needs.inventory_roads')
...
<div class="modal-content" id="intersection_edit">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('conservation_needs.labels.edit') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form"
                  action="{{ route('update.edit.conservation_needs.inventory_roads', ['gid' => $entity->gid]) }}"
                  method="post"
                  class="form-horizontal form-label-left" id="conservation_needs_edit_fm">
                @csrf
                        ...
                        <select class="form-control select2"
                            ...
                            @foreach($typeConversationNeeds as $typeConversationNeed)
                                <option value="{{ $typeConversationNeed->descrip }}"
                                        @if($entity->tipo == $typeConversationNeed->descrip) selected @endif>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <textarea name="observ" id="observ" class="form-control col-md-7 col-sm-7 col-xs-12" rows="5"
                                  placeholder="{{ trans('conservation_needs.placeholders.observ') }}">{{ $entity->observ }}</textarea>
                    </div>
                </div>
...
<script>
    $(() => {
        ...
        let $form = $('#conservation_needs_edit_fm');
