@permission('edit.traffic.inventory_roads')

<div class="modal-content" id="traffic_edit">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">
            <span aria-hidden="true">×</span>
        </button>
        <h4 class="modal-title" id="myModalLabel">
            <i class="fa fa-automobile"></i> {{ trans('traffic.labels.edit') }}
        </h4>
    </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_content">
            <form role="form" action="{{ route('update.edit.traffic.inventory_roads', ['gid' => $entity->gid]) }}"
                  method="post"
                  class="form-horizontal form-label-left" id="traffic_edit_fm">
                @csrf
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Numlivianos" id="Numlivianos"
                               ...
                               placeholder="{{ trans('traffic.placeholders.numlivianos') }}" value="{{ $entity->Numlivianos }}"/>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Tranlivianos" id="Tranlivianos"
                               ...
                               placeholder="{{ trans('traffic.placeholders.tranlivianos') }}" value="{{ $entity->Tranlivianos }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Numbuses" id="Numbuses"
                               class="form-control col-md-7 col-sm-7 col-xs-12 updateTotal"
                               placeholder="{{ trans('traffic.placeholders.Numbuses') }}" value="{{ $entity->Numbuses }}"/>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-2 mt-2">
                        <span class="label label-primary">{{ trans('app.labels.hdm4') }}</span>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Tranbuses" id="Tranbuses"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('traffic.placeholders.Tranbuses') }}" value="{{ $entity->Tranbuses }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Num2ejes" id="Num2ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12 updateTotal"
                               placeholder="{{ trans('traffic.placeholders.Num2ejes') }}" value="{{ $entity->Num2ejes }}"/>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-2 mt-2">
                        <span class="label label-primary">{{ trans('app.labels.hdm4') }}</span>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Tran2ejes" id="Tran2ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('traffic.placeholders.Tran2ejes') }}" value="{{ $entity->Tran2ejes }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Num3ejes" id="Num3ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12 updateTotal"
                               placeholder="{{ trans('traffic.placeholders.Num3ejes') }}" value="{{ $entity->Num3ejes }}"/>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-2 mt-2">
                        <span class="label label-primary">{{ trans('app.labels.hdm4') }}</span>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Tran3ejes" id="Tran3ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('traffic.placeholders.Tran3ejes') }}" value="{{ $entity->Tran3ejes }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Num4ejes" id="Num4ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12 updateTotal"
                               placeholder="{{ trans('traffic.placeholders.Num4ejes') }}" value="{{ $entity->Num4ejes }}"/>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-2 mt-2">
                        <span class="label label-primary">{{ trans('app.labels.hdm4') }}</span>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Tran4ejes" id="Tran4ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('traffic.placeholders.Tran4ejes') }}" value="{{ $entity->Tran4ejes }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Num5ejes" id="Num5ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12 updateTotal"
                               placeholder="{{ trans('traffic.placeholders.Num5ejes') }}" value="{{ $entity->Num5ejes }}"/>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-2 mt-2">
                        <span class="label label-primary">{{ trans('app.labels.hdm4') }}</span>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="Tran5ejes" id="Tran5ejes"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('traffic.placeholders.Tran5ejes') }}" value="{{ $entity->Tran5ejes }}"/>
                    </div>
                </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text"  disabled
                               ...
                               placeholder="{{ trans('traffic.placeholders.Total tráfico') }}" value="{{ $entity->{'Total tráfico'} }}"/>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-2 mt-2">
                        <span class="label label-primary">{{ trans('app.labels.hdm4') }}</span>
                    </div>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <select class="form-control select2"
                                id="tipo_dia_codigo" name="tipo_dia_codigo" required>
                            <option value="">{{ trans('app.labels.select') }}</option>
                            @foreach($typeDays as $typeDay)
                                <option value="{{ $typeDay->descrip }}" @if( $entity->tipo_dia_codigo == $typeDay->descrip) selected @endif>
                                    {{ $typeDay->descrip }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="item form-group">
                    ...
                    <div class="col-md-4 col-sm-5 col-xs-12">
                        <input type="text" name="dias_semana" id="dias_semana"
                               class="form-control col-md-7 col-sm-7 col-xs-12"
                               placeholder="{{ trans('traffic.placeholders.dias_semana') }}" value="{{ $entity->dias_semana }}"/>
                    </div>
                </div>
