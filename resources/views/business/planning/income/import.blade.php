<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">{{ trans('income.labels.import') }}</h4>
    </div>

    <div class="modal-body">
        <form role="form" action="{{ route('load.import.index.income.budget.plans_management') }}"
        ...
        <div class="alert alert-danger fw-b mt-3" role="alert">
            {{ trans('income.messages.confirm.import') }}
        </div>
