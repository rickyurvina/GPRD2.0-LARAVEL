<div class="modal-content">
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">{{ trans('current_expenditure.labels.import') }}</h4>
    </div>

    <div class="modal-body">
        <form role="form" action="{{ route('import.current_expenditure_elements.budget.plans_management') }}"
            ...
            <div class="col-md-5 col-sm-6 col-xs-7 pl-0">
                ...
                <div class="col-md-1 col-sm-1 col-xs-1 pl-0">
                    <i role="button" data-toggle="tooltip" data-placement="right"
                       data-original-title="{{ trans('income.labels.formats') }}"
        ...
        <div class="alert alert-danger fw-b mt-3" role="alert">
            {{ trans('current_expenditure.messages.confirm.import') }}
        </div>
    ...
    <div class="modal-footer">
        ...
        <button class="btn btn-success" id="submit-fm" data-dismiss="modal">
            <i class="fa fa-cloud-upload"></i> {{ trans('income.labels.import') }}
        </button>
    </div>
</div>
