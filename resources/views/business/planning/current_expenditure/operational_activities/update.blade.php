@permission('edit.operational_activities.current_expenditure_elements.budget.plans_management')
    ...
    $(() => {
        ...
        $('#submitBtn').click((e) => {
            ...
            if (operationalActivityForm.valid()) {
                ...
                let url = "{!! route('update.edit.operational_activities.current_expenditure_elements.budget.plans_management', ['id' => $entity->id]) !!}"
                let jsonData = {
                    _token: '{{ csrf_token() }}',
