<table class="table default-table" id="indicator_tb">
    ...
    @if(count($indicators) > 0)
        @include('business.planning.project_review.full_indicator.row', ['indicators' => $indicators])
    @else
        @include('business.planning.project_review.partial.empty', ['message' => trans('projects.messages.validation.table_empty_message'), 'span'=> 6])
    @endif
    </tbody>
</table>