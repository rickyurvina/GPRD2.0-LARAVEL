        ...
        <div id="container_{{ $file->name }}">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">
                <div class="input-group">
                    <div>
                        @permission('download.indexshow.projects_review.plans_management')
                        <a href="{{ route('download.indexshow.projects_review.plans_management', ['id' => $file->id]) }}"><span
