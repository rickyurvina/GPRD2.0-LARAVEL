@permission('edit.plan_elements.plans.plans_management')
@inject('PlanElement', '\App\Models\Business\PlanElement')

<div class="x_panel">
    <div class="x_title">
        <h2 class="align-center">{{ trans('plan_elements.labels.update', ['element' => trans('plan_elements.labels.'.$data['element_type'])])}}</h2>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="x_content">
                <form role="form" action="" method="post"
                      ...
                      class="form-horizontal form-label-left" id="planElementFormUpdate" novalidate>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <input name="element_code" id="element_code" maxlength="45"
                                   ...
                                   value="{{ $entity->code }}"
                                   @if(in_array($type, [$PlanElement::TYPE_PROGRAM, $PlanElement::TYPE_SUBPROGRAM] )) disabled @endif/>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <textarea name="element_description" id="element_description" rows="5" class="form-control">{{ $entity->description }}</textarea>
                        </div>
                    </div>
                    ...
                    @if(isset($type) && $type === $PlanElement::TYPE_PROGRAM)
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <textarea name="product" id="product" class="form-control" rows="5" maxlength="500">{{ $entity->product }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <textarea name="production_goal" id="production_goal" class="form-control" rows="5" maxlength="500">{{ $entity->production_goal }}</textarea>
                            </div>
                        </div>
                    @endif
...
<script>
    ...
    $(() => {
        ...
        let $form = $('#planElementFormUpdate');
        ...
        $validateDefaults.messages = {
            element_code: {
                remote: '{{ trans('plan_elements.messages.validations.uniqueCode', ['element'=> trans('plan_elements.labels.'.$entity->type)]) }}'
            }
        };
        ...
        $('#submitBtn').click((e) => {
            ...
            if ($form.valid()) {
                let url = "{!! route('update.edit.plan_elements.plans.plans_management', ['id' => $entity->id]) !!}";
                let jsonData = {
                    _token: '{{ csrf_token() }}',
                ...
                justificationModalMultiple(callback, jsonData, null, '{{ trans('justifications.actions.update') }}');
                @else
                callback();
                @endif
            }
