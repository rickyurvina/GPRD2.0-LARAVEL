...
<div class="x_panel">
    <div class="x_title">
        <h2 class="align-center">{{ trans('indicators.labels.edit') }}</h2>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="x_content">
                <form role="form" method="post"
                      ...
                      class="form-horizontal form-label-left" id="smallIndicatorFormEdit" novalidate>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="indicator_description" id="indicator_description" class="form-control">{{ $entity->description }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <textarea name="indicator_goal" id="indicator_goal" class="form-control">{{ $entity->goal_description }}</textarea>
                        </div>
                    </div>
...
<script>
    ...
    $(() => {
        ...
        let $form = $('#smallIndicatorFormEdit');
        ...
        $('#submitBtn').click((e) => {
            ...
            if ($form.valid()) {
                ...
                let url = "{!! route('update.edit.small.indicator.plan_elements.plans.plans_management', ['id' => $entity->id]) !!}";
