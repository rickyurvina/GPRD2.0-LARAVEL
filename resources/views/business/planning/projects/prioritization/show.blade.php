@permission('show.prioritization.plans_management')
<div>
    <div class="page-title">
        ...
        <div class="title_right hidden-xs">
            <ol class="breadcrumb pull-right">
                ...
                <li class="active">{{ trans('prioritization.labels.details') }}</li>
            </ol>
        </div>
    </div>
    ...
    <div class="row mb-16">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-crosshairs"></i> {{ trans('prioritization.labels.scope') . ' - ' . trans('prioritization.labels.project', ['cup' => $project->cup, 'name' => $project->name]) }}</h2>
                                        ...
                                        <div class="x_content">
                                            ...
                                            @foreach($scope->criteria as $criteria)
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        ...
                                                        <select disabled class="form-control select2" data-scope="{{ $scope->id }}" data-weight="{{ $scope->weight }}" data-criteria="{{ $criteria->id }}">
                                                            <option value=""></option>
                                            ...
                                            <div class="tile-stats prioritization-total">
                                                <div class="tile_stats_count tile_stats_count_margin pr-5 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="count_top_height"><span class="count_top"><i class="fa fa-crosshairs"></i> {{ $scope->scope . ' (' .trans('prioritization.labels.total') . ')' }}</span></div>
                                                ...
                                                <div class="tile_stats_count pl-5 col-md-6 col-sm-6 col-xs-6">
                                                    <div class="count_top_height"><span class="count_top"><i class="fa fa-calculator"></i> {{ trans('prioritization.labels.score') }}</span></div>
