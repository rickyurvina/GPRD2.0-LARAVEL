<table class="table default-table" id="indicator_activities_tb">
    ...
    @if(count($indicators) > 0)
        @include('business.planning.projects.logic_frame.components.indicators.row', ['indicators' => $indicators])
    @else
...
<script>
    $(() => {
        ...
        $('.delete_activity_indicator', '#indicator_activities_tb').on('click', (e) => {
            e.preventDefault();
