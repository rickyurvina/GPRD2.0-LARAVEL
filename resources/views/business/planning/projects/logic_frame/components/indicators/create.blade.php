...
<div class="modal-content">
    ...
    <div class="x_content">
        <div class="" role="tabpanel" data-example-id="togglable-tabs">
            ...
            <form role="form"
                  action="{{ route($urlStoreComponentIndicator, ['componentId' => $componentId]) }}"
                  method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" id="planIndicatorCreateFm" novalidate>
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="form-control select2 select2_measuring_unit" id="measuring_unit" name="measure_unit_id">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea name="source" id="source" rows="5" class="form-control col-md-7 col-sm-7 col-xs-12 vertical"></textarea>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-1 col-sm-1 col-xs-2">
                                                <span class="fa fa-info-circle fa-2x"
                                                      data-toggle="tooltip" rel="tooltip" data-placement="right"
                                                      title="{{ trans('plan_indicators.base_line_description') }}">
                                                </span>
                                            </div>
                                        </div>
                                        <div class="item form-group">
                                    ...
                                    <div class="x_panel">
                                        <div class="x_content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-4 col-xs-12">
                                                    <span>
                                                        <b>{{ trans('plan_indicators.labels.goal') }}{{ trans('plan_indicators.labels.year') }}</b>
                                                    </span>
                                                    <b> </span>
                                                        {{ $yearPlanning }}
                                                        </span>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12 mt-4">
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="form-control select2 select2_type" id="type" name="type">
                                                ...
                                                <div class="item form-group" id="goal_type_div">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <select class="form-control select2 select2_goal_type" id="goal_type" name="goal_type">
                                                            <option value="">{{ trans('app.labels.select') }}</option>
                                            ...
                                            <table border="1" align="center" id="tableDiv" hidden>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" data-bind="style: { 'border': styling }">
                                                        <div class="col-md-6 col-sm-6 col-xs-12 ml-25 table-cell">
                                                            <input type="number"
                                                                   onclick="this.select()"
                                                    ...
                                                    <td align="center">
                                                        <div class="col-md-3 col-sm-3 col-xs-12 ml-30 table-cell">
                                            ...
                                            <table border="1" align="center" id="tableToleranceDiv" hidden>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <input type="number"
                                                               onclick="this.select()"
                                                               data-bind=" value: max, attr:{id:'max' + id, required:true, name:'max' + id, min: 0}"
                                                               class="form-control col-md-12 col-sm-12 col-xs-12"
                                                               placeholder="0"/>
                                                    </td>
                                                </tr>
                                            ...
                                            <div id="myChart" class="echart-700 col-md-11 col-sm-11 col-xs-12 mt-4">
                                            </div>
                                            <div class="row">
...
<script>
    $(() => {
        ...
        let createChart = (index, value) => {
            barOptions.series[0].data[index].value = value;
            barOptions.title.text = $("#indicatorName").val();
            barOptions.title.subtext = '{{ trans('plan_indicators.labels.base_line') }}: ' + $('#base_line').val() +
                '\n{{ trans('plan_indicators.labels.base_line_year') }}: ' + $('#base_line_year').val();
            barOptions.yAxis[0].name = measuringUnitSelect.find("option:selected").text();
            myChart.setOption(barOptions, true);
        };

        //Función para pintar la grafica de tolerancia
        let createChartToleranceMin = (index, min) => {
            toleranceOptions.series[0].data[index] = min;
            toleranceOptions.title.text = $("#indicatorName").val();
            toleranceOptions.title.subtext = '{{ trans('plan_indicators.labels.base_line') }}: ' + $('#base_line').val() +
                '\n{{ trans('plan_indicators.labels.base_line_year') }}: ' + $('#base_line_year').val();
            toleranceOptions.yAxis[0].name = $("#measuring_unit option:selected").text();
            myChart.setOption(toleranceOptions, true);
        };

        //Función para pintar la grafica de tolerancia
        let createChartToleranceMax = (index, max) => {
            toleranceOptions.series[1].data[index] = max;
            myChart.setOption(toleranceOptions, true);
        };
        ...
        let createDataset = (frequency) => {
            ...
            barOptions.xAxis[0].data = xData;
            barOptions.series[0].data = seriesData;
            barOptions.series[1].data = seriesData;
            createChart(0, 0);
        };
        ...
        let createDatasetTolerance = (frequency) => {
            ...
            toleranceOptions.xAxis[0].data = xData;
            toleranceOptions.series[0].data = minData;
            toleranceOptions.series[1].data = maxData;
        ...
        $(".measure_unit_abbrev").text(measuringUnitSelect.attr('data-abbv'));

        $("#measuring_unit", $planIndicatorCreateFm).on('change', (element) => {
            let selected = $(element.target).find('option:selected');
            $("#measuringUnitLabel").text(selected.text());
            $("#measuringUnitValue").text(selected.text());
            $(".measure_unit_abbrev").text(selected.attr('data-abbv'));
        });
        ...
        $("#measurement_frequency_per_year", $planIndicatorCreateFm).on('change', () => {
            ...
            if (typeIndicator === '{{ $PlanIndicatorGoal::getTolerance() }}') {
                ...
                if ($("#type").val() !== '' && measurementFrequencyPerYearSelect.val() !== '') {
                ...
                if ($("#type").val() !== '' && measurementFrequencyPerYearSelect.val() !== '' && $("#goal_type").val() !== '') {
        ...
        $("#goal_type", $planIndicatorCreateFm).on('change', () => {
            let measurementFrequencyPerYearSelect = $('#measurement_frequency_per_year');
            let goalTypeSelect = $("#goal_type");
            goalType = goalTypeSelect.val();
            if (measurementFrequencyPerYearSelect.val() > 0) {
                count = measurementFrequencyPerYearSelect.val();
            }
            $("#type1").text(goalTypeSelect.find('option:selected').text());
            if (goalTypeSelect.find('option:selected').text() === '{{ trans('plan_indicators.labels.cumulative') }}') {
        ...
        $("#type", $planIndicatorCreateFm).on('change', () => {
            ...
            if (typeIndicator === '{{ $PlanIndicatorGoal::getTolerance() }}') {
                ...
                if (typeIndicator !== '' && measurementFrequencyPerYearSelect.val() !== '') {
                ...
                if (typeIndicator !== '' && measurementFrequencyPerYearSelect.val() !== '' && goalType.val() !== '') {
                    $('#goal_type_div').show();
                    $('#tableToleranceDiv').hide();
                    $('#tableDiv').show();
                    groupFunctionsIsPei();
                    ...
                    if (goalType === '{{ $PlanIndicatorGoal::getDiscrete() }}') {
                        ...
                        if (value < goal || value > baseline) {
                            ...
                            if (row.id === 0) {
                                ...
                                if (value < goal || self.rows()[row.id - 1].value()) {
                                    row.styling('2px solid red');
                                    row.validRow = false;
                                } else {
                                    row.styling('');
