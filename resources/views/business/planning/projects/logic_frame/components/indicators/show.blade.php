...
<div class="modal-content">
    ...
    <div class="x_content">
        <div class="" role="tabpanel" data-example-id="togglable-tabs">
            ...
            <div id="myTabContent" class="tab-content form-horizontal form-label-left">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="row">
                                            ...
                                            <b>{{ trans('plan_indicators.labels.base_line') }}{{ trans('plan_indicators.labels.year') }}
                                                <span id="lineBaseYearValue"> {{ $entity->base_line_year }}</span> :</b> <span
                                                        id="lineBaseValue"
                                                        class="badge badge-warning"> {{ $entity->base_line }} </span> </span>
                                            ...
                                            <b>{{ trans('plan_indicators.labels.goal') }} {{ trans('plan_indicators.labels.year') }} {{ $yearPlanning }}</span>:</b>
                                                <span id="goalValue"
                                                      class="badge badge-warning"> {{ $entity->goal }} </span>
                                                </span>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 mt-4">
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-2">
                                                    <span class="fa fa-info-circle fa-2x"
                                                          ...
                                                          data-original-title="{{ trans('plan_indicators.type_description') }}">
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-2">
                                                    <span class="fa fa-info-circle fa-2x"
                                                          data-toggle="tooltip" rel="tooltip" data-placement="right"
                                                          data-original-title="{{ trans('plan_indicators.goal_type_description') }}">
                                                    </span>
                                                </div>
                                            </div>
                                        ...
                                        <table border="1" align="center" id="tableDiv" hidden>
                                            <tr>
                                                ...
                                                <th align="center">
                                                    <label id="type2" class="control-label col-md-3 col-sm-3 col-xs-12 table-cell"
                                                           for="valor">
                                                        @if($entity->goal_type == $PlanIndicatorGoal::getDiscrete())
                                                            {{ trans('plan_indicators.labels.cumulative') }}
                                                        @else
                                                ...
                                                <td align="center">
                                                    <div class="col-md-6 col-sm-6 col-xs-12 table-cell">
                                                        <input disabled="true" type="number"
                                                               data-bind=" value: value, attr:{id: id, required:true, name:id, min: 0}"
                                        ...
                                        <table border="1" align="center" id="tableToleranceDiv" hidden>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <input disabled="true" type="number"
                                                               data-bind="value: min, attr:{id: id, required:true, name:'min' + id, min: 0}"
                                                               class="form-control col-md-7 col-sm-7 col-xs-12 number-input-cell"
                                                               placeholder="0"/>
                                                ...
                                                <td align="center">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <input disabled="true" type="number"
                                                               data-bind=" value: max, attr:{id: id, required:true, name:'max' + id, min: 0}"
                                                               class="form-control col-md-7 col-sm-7 col-xs-12 number-input-cell"
                                                               placeholder="0"/>
...
<script>
    $(() => {
        ...
        //función para definir cada filal
