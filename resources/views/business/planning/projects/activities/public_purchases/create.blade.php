...
<div class="modal-content" id="myModal">
    ...
    @if(isset($activityType) && $activityType === $BudgetItem::ACTIVITY_TYPE_OPERATIONAL)
        <form method="post" action="{{ route('store.create.purchases.items.operational_activities.current_expenditure_elements.budget.plans_management', ['budgetItemId' =>
        $budgetItem->id]) }}"
          class="form-horizontal form-label-left"
          id="public_purchase_create_fm" novalidate>
    @else
        <form method="post" action="{{ route('store.create.purchases.items.activities.projects.plans_management', ['budgetItemId' => $budgetItem->id]) }}"
                  class="form-horizontal form-label-left"
                  id="public_purchase_create_fm" novalidate>
    @endif
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-1">
                        <input type="checkbox" name="c1" id="c1" class="js-switch"/>
                    </div>
                    ...
                    <div class="col-md-1">
                        <input type="checkbox" name="c2" id="c2" class="js-switch"/>
                    </div>
                    ...
                    <div class="col-md-1">
                        <input type="checkbox" name="c3" id="c3" class="js-switch"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12 mt-2">
                        <input type="checkbox" id="apply_vat" class="js-switch" checked/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="text" name="amount" id="amount" class="form-control mt-0" required min="{{ $PublicPurchase::MIN_ALLOWED_VALUE }}"
                                   maxlength="16" max="{{ $PublicPurchase::MAX_ALLOWED_VALUE }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="text" name="amount_no_vat" id="amount_no_vat" class="form-control mt-0" required readonly>
                        </div>
                    </div>
                </div>
            </div>
