@if(currentUser()->can('edit.items.activities.projects.plans_management') || currentUser()->can('edit.items.operational_activities.current_expenditure_elements.budget.plans_management'))
...
<div class="modal-content" id="myModal">
    ...
    <form method="post" action="{{ route('update.edit.items.operational_activities.current_expenditure_elements.budget.plans_management', ['budgetItemId' => $budgetItem->id, 'activityType' => $activityType]) }}"
          class="form-horizontal form-label-left" id="budget_item_update_fm">
    @else
    <form method="post" action="{{ route('update.edit.items.activities.projects.plans_management', ['budgetItemId' => $budgetItem->id]) }}" class="form-horizontal form-label-left"
