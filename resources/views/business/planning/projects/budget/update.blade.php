...
<div class="modal-content" id="myModal">
    ...
    <form method="post" action="{{ route('update.edit.index.budget.projects.plans_management', ['budgetItemId' => $budgetItem->id]) }}" class="form-horizontal form-label-left"
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_content">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="activity_project_fiscal_year_id">
                        {{ trans('budget_item.labels.activity') }} <span class="text-danger">*</span>
                    </label>
                    <div class="col-md-9 col-xs-12">
                        <select class="form-control select2" id="activity_project_fiscal_year_id" name="activity_project_fiscal_year_id" required>
                            <option value=""></option>
                            @foreach($projectFiscalYear->activitiesProjectFiscalYear as $act)
                                <option value="{{ $act->id }}" data-code="{{ $act->code }}" data-area-code="{{ $act->area->code }}"
                                        @if($act->id == $budgetItem->activity_project_fiscal_year_id) selected @endif>
                                    {{ $act->code }} - {{ $act->name }}
                                </option>
                            @endforeach
                        </select>
    ...
    $(() => {
        ...
        $('.select2').select2({
            ...
            switch ($(e.currentTarget).attr('id')) {
                case 'activity_project_fiscal_year_id':
