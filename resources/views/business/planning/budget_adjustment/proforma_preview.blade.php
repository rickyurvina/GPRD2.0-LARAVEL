@permission('after_preview_proforma.budget_adjustment.budget.plans_management')
...
<script>
    $(() => {
        ...
        build_datatable($('#proforma_tb'), {
            dom: 't',
            ajax: {
                url: '{!! route('data.after_preview_proforma.budget_adjustment.budget.plans_management') !!}',
                "dataSrc": (response) => {
