...
<div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-refresh"></i> {{ trans('reprogramming.labels.new') }}</h2>
                ...
                <div class="x_content">
                    <form role="form" action="{{ route('store.create.reprogramming.reforms_reprogramming.execution') }}" method="post"
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="document" value="{{ $code }}" readonly disabled class="form-control col-md-7 col-sm-7 col-xs-12"/>
                            </div>
                        </div>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="description" id="description" maxlength="200" rows="4" required class="form-control vertical"
                                          onkeyup="this.value = this.value.charAt(0).toUpperCase() + this.value.slice(1);"></textarea>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="file">
                                {{ trans('reprogramming.labels.file') }} <span class="text-danger">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
