@permission('projects.indicator_progress.execution')
    ...
    <div class="page-title">
        ...
        <div class="title_right hidden-xs">
            <ol class="breadcrumb pull-right">
                <li class="active"> {{ trans('indicator_tracking.title_projects') }}</li>
            </ol>
        </div>
    </div>
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-11 col-sm-11 col-xs-11">
                        <h2>
                            <i class="fa fa-tasks"></i> {{ trans('indicator_tracking.title_projects') }}
                        </h2>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    ...
                    @if($checkPEI && $checkBudgetAdjustment)
                        @include('business.execution.indicators.filters', [
                            ...
                            'type' => $PlanIndicator::INDICATORABLE_PROJECT,
                            'url' => 'data.projects.indicator_progress.execution',
                            'plan_type' => false
                         ])
                    @else
                        @if(!$checkPEI)
