@permission('components.indicator_progress.execution')
    ...
    <div class="page-title">
        ...
        <div class="title_right hidden-xs">
            <ol class="breadcrumb pull-right">
                <li class="active"> {{ trans('indicator_tracking.title_components') }}</li>
            </ol>
        </div>
    </div>
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-11 col-sm-11 col-xs-11">
                        <h2>
                            <i class="fa fa-tasks"></i> {{ trans('indicator_tracking.title_components') }}
                        </h2>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    ...
                    @if($checkPEI && $checkBudgetAdjustment)
                        @include('business.execution.indicators.filters', [
                            ...
                            'type' => $PlanIndicator::INDICATORABLE_COMPONENT,
                            'url' => 'data.components.indicator_progress.execution',
                            'plan_type' => false
                         ])
                    @else
                        @if(!$checkPEI)
