@permission('sectoral.indicator_progress.execution')
    ...
    <div class="page-title">
        ...
        <div class="title_right hidden-xs">
            <ol class="breadcrumb pull-right">
                <li class="active"> {{ trans('indicator_tracking.title_sectoral') }}</li>
            </ol>
        </div>
    </div>
            ...
            <div class="x_panel">
                <div class="x_title">
                    <div class="col-md-11 col-sm-11 col-xs-11">
                        <h2>
                            <i class="fa fa-tasks"></i> {{ trans('indicator_tracking.title_sectoral') }}
                        </h2>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    ...
                    @if($checkSECTORAL)
                        @include('business.execution.indicators.filters', [
                            ...
                            'url' => 'data.sectoral.indicator_progress.execution',
                            'plan_type' => $Plan::TYPE_SECTORAL
                         ])
                    @else
                        <div class="alert alert-warning align-center" role="alert">
                            {{ trans('indicator_tracking.messages.validations.noVerifiedSECTORAL') }}
                        </div>
                    @endif
