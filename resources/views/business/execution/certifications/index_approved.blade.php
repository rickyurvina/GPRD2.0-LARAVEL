                    ...
                    $(() => {
                        let $table = build_datatable($('#certification_tb'), {
                            ajax: {
                                ...
                                "data": (d) => {
                                    return $.extend({}, d, {
                                        status: ['{{ \App\Models\Business\Certification::STATUS_APPROVED }} ', '  {{ \App\Models\Business\Certification::STATUS_DIGITATED }}'],
                                    });
                                }
                            },
                            columns: [
                        ...
                        $('#certification_tb tbody').on('click', 'tr', (e) => {
                            ...
                            let url = '{{ route('show.certifications.execution', ['id' => '__ID__']) }}'
