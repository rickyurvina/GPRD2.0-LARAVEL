@if(currentUser()->can('edit.items.activities.project.programmatic_structure.execution'))
    ...
    <div class="modal-content" id="myModal">
        ...
        <form method="post" action="{{ route('update.edit.items.operational_activities.current_expenditure_elements.programmatic_structure.execution', ['budgetItemId' => $budgetItem->id, 'activityType' => $activityType, 'module' => $BudgetItem::MODULE['PROGRAMMATIC_STRUCTURE']]) }}"
              class="form-horizontal form-label-left" id="budget_item_update_fm">
        @else
        <form method="post" action="{{ route('update.edit.items.activities.project.programmatic_structure.execution', ['budgetItemId' => $budgetItem->id, 'module' => $BudgetItem::MODULE['PROGRAMMATIC_STRUCTURE']]) }}"
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_content">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <select class="form-control select2" id="financing_source_id" name="financing_source_id" required>
                                ...
                                @foreach($financingSources as $source)
                                    <option value="{{ $source->id }}" data-code="{{ $source->code }}" @if($budgetItem->financing_source_id && $source->id == $budgetItem->financing_source_id) selected @endif>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <select class="form-control select2" id="institution_id" name="institution_id" data-width="100%">
                                <option value=""></option>
                    ...
                    <div class="form-group" style="display: @if($budgetItem->institution_id) block @else none @endif;" id="div_loan_id">
    ...
    <script>
        $(() => {
            ...
            @if(isset($activityType) && $activityType === $BudgetItem::ACTIVITY_TYPE_OPERATIONAL)
                ...
                @if($activity)'{{ $activity->code }}', @else '{{ $BudgetItem::CODE_00 }}', @endif // Act
            ...
            /**
             * Muestra u oculta campo Valor de la partida presupuestaria
             * @param element
             */
            let showAmount = (element) => {
