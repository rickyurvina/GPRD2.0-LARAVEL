@permission('modify.purchases.items.activities.project.programmatic_structure.execution | modify.purchases.items.operational_activities.current_expenditure_elements.programmatic_structure.execution')
...
<div class="modal-content" id="myModal">
    ...
    @if(isset($activityType) && $activityType === $BudgetItem::ACTIVITY_TYPE_OPERATIONAL)
        <form method="post" action="{{ route('update.modify.purchases.items.operational_activities.current_expenditure_elements.programmatic_structure.execution', ['purchaseId' => $purchase->id]) }}" class="form-horizontal form-label-left"
          id="public_purchase_update_fm" novalidate>
    @else
        <form method="post" action="{{ route('update.modify.purchases.items.activities.project.programmatic_structure.execution', ['purchaseId' => $purchase->id]) }}" class="form-horizontal form-label-left"
                  id="public_purchase_update_fm" novalidate>
    @endif
