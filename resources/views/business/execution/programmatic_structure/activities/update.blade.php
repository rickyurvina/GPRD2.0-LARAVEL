...
@permission('edit.activities.project.programmatic_structure.execution')
<div class="modal-content" id="myModal">
    ...
    <form role="form" method="post" action="{{ route('update.edit.activities.project.programmatic_structure.execution', ['id' => $entity->id]) }}"
        ...
        <div class="x_content">
            ...
            <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <label class="mt-3">{{ $entity->code }}</label>
                </div>
            </div>
            ...
            <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="area">
                    {{ trans('activities.labels.area') }} <span class="required text-danger">*</span>
                </label>{{ $ProjectFiscalYear->STATUS_IN_PROGRESS  }}
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="form-control select2 select2_area" id="area" name="area_id"
                            @if($entity->projectFiscalYear->status == $ProjectFiscalYear::STATUS_IN_PROGRESS and $entity->budgetItems->count()) disabled @endif>
