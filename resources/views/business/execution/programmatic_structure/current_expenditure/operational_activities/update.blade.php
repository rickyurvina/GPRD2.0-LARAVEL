@permission('edit.operational_activities.current_expenditure_elements.programmatic_structure.execution')

<div class="x_panel">
    <div class="x_title">
        <h2 class="align-center">{{ trans('operational_activities.labels.update') }}</h2>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="x_content">
                <form role="form" method="post" class="form-horizontal form-label-left" id="operationalActivityFormEdit">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <select class="form-control select2" id="responsible_unit_id" disabled>
                                <option value=""></option>
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <select class="form-control select2" id="executing_unit_id" disabled>
                                <option value=""></option>
                                @foreach($departments as $department)
...
<script>
    ...
    $(() => {
        ...
        let operationalActivityForm = $('#operationalActivityFormEdit')
        ...
        $('#submitBtn').click((e) => {
            ...
            if (operationalActivityForm.valid()) {
                ...
                let url = "{!! route('update.edit.operational_activities.current_expenditure_elements.programmatic_structure.execution', ['id' => $entity->id]) !!}"
                let jsonData = {
                    _token: '{{ csrf_token() }}',
