@permission('create.operational_activities.current_expenditure_elements.programmatic_structure.execution')
    ...
    $(() => {
        ...
        $('#submitBtn').click((e) => {
            ...
            if (operationalActivityForm.valid()) {
                ...
                let url = "{!! route('store.create.operational_activities.current_expenditure_elements.programmatic_structure.execution') !!}"
                let jsonData = {
                    _token: '{{ csrf_token() }}',
