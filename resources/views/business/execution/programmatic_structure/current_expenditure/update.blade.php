@permission('edit.current_expenditure_elements.programmatic_structure.execution')
    ...
    $(() => {
        ...
        $('#submitBtn').click((e) => {
            ...
            if (currentExpenditureElementForm.valid()) {
                ...
                let url = "{!! route('update.edit.current_expenditure_elements.programmatic_structure.execution', ['id' => $entity->id]) !!}"
                let jsonData = {
                    _token: '{{ csrf_token() }}',
