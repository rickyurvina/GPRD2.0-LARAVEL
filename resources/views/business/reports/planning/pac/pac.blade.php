                ...
                <div class="title_left">
                    ...
                    <div class="col-md-8 col-sm-8 col-xs-12 mt-3">
                        <div class="text-right pull-right">
                            @permission('export_xls.index.pac.reports')
...
<script>
    $(() => {
        ...
        let export_url = '{{ route('export_xls.index.pac.reports', ['fiscalYearId' => '__FISCAL_YEAR__']) }}';
        ...
        let dataTable = build_datatable($('#pac_tb'), {
            dom: 'tr',
            ajax: {
                url: '{!! route('data.index.pac.reports') !!}',
                "data": (d) => {
                    return $.extend({}, d, {
        ...
        $('#export_pdf').on('click', () => {
            ...
            doc.autoTable({
                ...
                showFoot: 'lastPage',
                didDrawPage: (data) => {
                    doc = setDocHeaderAndFooter(data, doc, logoBase64, '{{ trans('reports.pac.title') }}', '{{ $gad }}', `{{ trans('app.labels.date') }}: ${moment().format('DD/MM/YYYY')}`, totalPagesExp);
                },
            ...
            doc.save('{{ trans('reports.pac.title') }}' + '.pdf')
        });
