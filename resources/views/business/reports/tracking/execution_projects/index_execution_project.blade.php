...
<div>
    <div class="page-title">
        <div class="col-md-10 col-sm-10 col-xs-10">
            ...
            <h2>
                <i class="fa fa-product-hunt"></i> {{ trans('reports.execution_projects.title') }}
            </h2>
        </div>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 mt-3">
                            <div class="text-right pull-right">
                                @permission('export.index.execution_projects.reports')
...
<script>
    $(function () {
        ...
        $('#export_pdf').on('click', (e) => {
            ...
            $.ajax({
                url: '{{ route('export.index.execution_projects.reports') }}',
                method: 'GET',
                data: {
                ...
                success: (response) => {
                    ...
                    a.href = url;
                    a.download = '{{ trans('reports.execution_projects.filename') }}';
